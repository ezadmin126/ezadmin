...
public enum ItemDataSourceType {
    TEXT, JSON, KVSQL, HTTP, JOIN, KVSQLCACHEFOREVER, KVSQLCACHE, HTTPCACHE, QLEXPRESS, KVSQLCACHE5, EZLIST, KVJSONRESULT, CASCADER, KVSQL2TREE, KVSQL2TREECACHE, DATAGROUP;
