...
import io.github.ezadmin126.plugins.parser.parse.GenericTokenParser;
import io.github.ezadmin126.plugins.parser.parse.Params;
import io.github.ezadmin126.plugins.parser.parse.ResultModel;
import io.github.ezadmin126.plugins.parser.parse.TokenHandler;
...
public class MapParser {
    ...
    public static ResultModel parse(String string, Map<String, Object> variables) {
        ...
        GenericTokenParser parser = new GenericTokenParser(PARAM_PREFIX, PARAM_SUFFIX, handler);
    ...
    public static ResultModel parseDefaultEmpty(String string, Map<String, Object> variables) {
        ...
        if (!StringUtils.contains(string, PARAM_SUFFIX)) {
            model2.setResult(string);
            return model2;
        }

        try {
            variables.put(DEFAULT_EMPTY_KEY, true);
        } catch (Exception e) {//
            //ignor
    ...
    private static class VariableTokenHandler implements TokenHandler {
        ...
        public String handleToken(String content) {
            ...
            if (variables.containsKey(DEFAULT_EMPTY_KEY) || s > 0) {
                return "";
            }
            return PARAM_PREFIX + content + PARAM_SUFFIX;
        }
