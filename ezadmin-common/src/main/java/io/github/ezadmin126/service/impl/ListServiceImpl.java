package io.github.ezadmin126.service.impl;

import io.github.ezadmin126.common.enums.*;
...
import io.github.ezadmin126.common.annotation.EzCacheAnnotation;
import io.github.ezadmin126.common.constants.SelectKVContants;
import io.github.ezadmin126.dao.Dao;
import io.github.ezadmin126.dao.ListDao;
import io.github.ezadmin126.dao.PluginsDao;
import io.github.ezadmin126.dao.model.CustomSearchDTO;
import io.github.ezadmin126.dao.model.CustomSearchOrder;
import io.github.ezadmin126.dao.model.ItemInitData;
import io.github.ezadmin126.plugins.cache.Callback;
import io.github.ezadmin126.plugins.express.executor.DefaultExpressExecutor;
import io.github.ezadmin126.plugins.express.executor.ListExpressExecutor;
            ...
            for (int i = 0; i < dataList.size(); i++) {
                ...
                for (int j = 0; j < colList.size(); j++) {
                    ...
                    try {
                        ...
                        context.setVariable("uploadUrl", requestParamMap.get("ContextPath") + EzBootstrap.config().getUploadUrl());
                        if (StringUtils.startsWith(EzBootstrap.config().getDownloadUrl(), "http")) {
                            context.setVariable("downloadUrl", EzBootstrap.config().getDownloadUrl());
                        } else {
                            context.setVariable("downloadUrl", requestParamMap.get("ContextPath") + EzBootstrap.config().getDownloadUrl());
                        }
