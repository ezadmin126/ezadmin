...
import io.github.ezadmin126.plugins.cache.CaffeineCache;
import io.github.ezadmin126.plugins.cache.EzCache;
import io.github.ezadmin126.plugins.export.CSVExport;
import io.github.ezadmin126.plugins.export.EzExport;
import io.github.ezadmin126.plugins.refresh.DefaultRefresh;
import io.github.ezadmin126.plugins.refresh.EzRefresh;
import io.github.ezadmin126.plugins.templates.EzTemplate;
...
public class EzBootstrapConfig {
     ...
     * 导出类名，指定数据导出功能的实现类
     */
    private String exportClass = "io.github.ezadmin126.plugins.export.CSVExport";
     ...
     * 缓存类名，指定缓存功能的实现类
     */
    private String cacheClass = "io.github.ezadmin126.plugins.cache.CaffeineCache";
    private EzCache ezCache=new CaffeineCache();

    /**
     * 刷新类名，指定数据刷新功能的实现类
     */
    private String refreshClass = "io.github.ezadmin126.plugins.refresh.DefaultRefresh";
