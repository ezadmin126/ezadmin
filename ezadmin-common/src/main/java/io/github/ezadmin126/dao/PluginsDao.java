...
public class PluginsDao {
    ...
    private void loadPlugins() {
        for (int i = 0; i < EzBootstrap.config().getPluginsFormConfigResources().size(); i++) {
            explainConfig(EzBootstrap.config().getPluginsFormConfigResources().get(i), pluginsAllConfigMap);
        }
        for (int i = 0; i < EzBootstrap.config().getPluginsListConfigResources().size(); i++) {
            explainConfig(EzBootstrap.config().getPluginsListConfigResources().get(i), pluginsAllConfigMap);
        }
    }
