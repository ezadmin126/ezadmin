...
import static io.github.ezadmin126.common.utils.Utils.logger;
...
//    }
    ...
    public static String decodeSafeFromUrl(String key) throws Exception {
        try {
            String base64 = new String(Base64.getUrlDecoder().decode(key.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
            // 加密
