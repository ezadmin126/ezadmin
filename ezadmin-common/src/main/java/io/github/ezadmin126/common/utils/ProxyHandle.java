...
public class ProxyHandle implements InvocationHandler {
    ...
    private Object getImplInstanceByMethod(Method method) throws InstantiationException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException {
    ...
    private Object invokeMethod(final Object instance, final Method method, final Object[] args) throws InvocationTargetException, IllegalAccessException {
        ...
        if (annotation != null) {
            ...
            return EzBootstrap.config().getEzCache().get(key, args == null ? "" : StringUtils.join(args), callback);
        }
