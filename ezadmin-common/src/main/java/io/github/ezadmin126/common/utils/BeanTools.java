...
public abstract class BeanTools {
    ...
    @Deprecated
    public static Object mapToBean(Map<String, String> map, Class className) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
