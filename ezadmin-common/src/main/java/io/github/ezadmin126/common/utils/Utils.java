...
import io.github.ezadmin126.common.enums.ColTypeEnum;
import io.github.ezadmin126.common.enums.DefaultParamEnum;
import io.github.ezadmin126.common.enums.JdbcTypeEnum;
import io.github.ezadmin126.common.enums.OperatorEnum;
import io.github.ezadmin126.web.JsonArrayResult;
    ...
    public static String loadHttp(String id, String initData) throws Exception {
        ...
        if (StringUtils.isNotBlank(responseKey)) {
            ...
            for (int j = 0; j < key.length; j++) {
                Object v = ((Map<String, Object>) test.getData().get(0)).get(key[j]);
                v = v == null ? "0" : v;
