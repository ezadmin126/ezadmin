            ...
            if (typeof s != "undefined") {
                ...
                if (v) {
                    ...
                    if (s.type === "paren.rparen") {
                        ...
                        for (A = 0; A < v.length; A++) g--, v.substr(A, 1) === "}" && H[g] === "case" && g--
                    }
