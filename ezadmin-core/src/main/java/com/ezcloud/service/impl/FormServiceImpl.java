package com.ezcloud.service.impl;
...
import com.ezcloud.dao.model.ItemInitData;
import com.ezcloud.common.annotation.EzCacheAnnotation;
import com.ezcloud.common.enums.ItemDataSourceType;
import com.ezcloud.common.enums.ParamNameEnum;
import com.ezcloud.common.utils.*;
import com.ezcloud.plugins.express.executor.DefaultExpressExecutor;
import com.ezcloud.plugins.parser.MapParser;
...
Logger logger= LoggerFactory.getLogger(FormServiceImpl.class);
    ...
    @Override
    @EzCacheAnnotation
    public Map<String, Object> selectAllFormByHtml(String ezConfig,String adminStyle) {
        return FormDao.getInstance().selectAllFormByHtml(ezConfig);
    }
