...
import com.ezcloud.common.enums.ContentTypeEnum;
...
import com.ezcloud.common.EzAdminRuntimeException;
...
public class FormController extends BaseController {
    ...
    public String form(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        request.setAttribute("formUrl",request.getContextPath()+"/ezcloud/form/form-"+ ENCRYPT_FORM_ID);
        //自定义ID
