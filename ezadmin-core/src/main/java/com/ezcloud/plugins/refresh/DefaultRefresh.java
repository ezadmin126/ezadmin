    ...
    public  void refreshAll() throws IOException {
        if(!EzClientBootstrap.instance().isSqlCache()){
            ...
            new Thread(){
                public void run(){
                    try {
                        File listfold = new File(JsoupUtil.editPath("ezcloud"+File.separator+"config"+File.separator+EzClientBootstrap.instance().getAdminStyle())
                                );
//                        listfold.toPath().register(watcher,  ENTRY_MODIFY);
//                        File formfold = new File(JsoupUtil.editPath("ezcloud"+File.separator+"config"+File.separator+EzClientBootstrap.instance().getAdminStyle())
//                                +File.separator+"form");
//                        formfold.toPath().register(watcher,  ENTRY_MODIFY);
