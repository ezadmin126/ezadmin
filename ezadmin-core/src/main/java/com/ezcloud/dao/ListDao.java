package com.ezcloud.dao;

import com.ezcloud.EzClientBootstrap;
import com.ezcloud.common.enums.JdbcTypeEnum;
import com.ezcloud.common.enums.OperatorEnum;
    ...
    private void fillbuttoncol(Map<String, Object> coreMap,Document doc) {
        ...
        if(rowbutton!=null) {
            ...
            try {
                ...
                coreMap.put("rowbuttonfixed",Utils.trimNull(rowbutton.attr("fixed") ));
        ...
        Element column = doc.getElementById("column");
         if (column != null) {
            ...
            for (int x = 0; x < thList.size(); x++) {
                ...
                thMap.put(JsoupUtil.LABEL, Utils.trimEmptyDefault(thMap.get(JsoupUtil.LABEL),th.ownText()) );
...
//        Document doc=config.getDoc();
    ...
    public String updateList(Map<String, Object> list) throws  Exception {
        ...
        String rowbuttonwidth=  Utils.trimNull( coreMap.get("rowbuttonwidth"));
        String rowbuttonfixed=  Utils.trimNull( coreMap.get("rowbuttonfixed"));
        ...
        if (config==null) {
            ...
            try {
                editPath=JsoupUtil.editPath("ezcloud" + File.separator + "config") + File.separator +
                        EzClientBootstrap.instance().getAdminStyle() + File.separator + "list" +
                        File.separator + listcode.toLowerCase() + ".html";
            }catch (Exception e){
               String rootPath=editPath + File.separator+"ezcloud" + File.separator + "config"+ File.separator +
                        EzClientBootstrap.instance().getAdminStyle() + File.separator + "list"   ;
