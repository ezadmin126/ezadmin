...
public class FormDao extends JsoupUtil{
    ...
    public   Map<String, String> selectFormById(String formCode) {
        ...
        //adminstyle
      //  String[] path=config.getPath().substring(config.getPath().indexOf("ezcloud/config")+"ezcloud/config".length()).split("/");
...
//            String editPath=JsoupUtil.editPath("ezcloud"+File.separator+"config")+File.separator+
