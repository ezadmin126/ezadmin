...
public class FormEditController extends BaseController {
    ...
    public String sourceEdit(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String ENCRYPT_FORM_ID = Utils.trimNull(request.getAttribute("ENCRYPT_FORM_ID"));
    ...
    public String form(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return sourceEdit(request, response);
    }

    @EzMapping(value = "preview.html", name = "view")
