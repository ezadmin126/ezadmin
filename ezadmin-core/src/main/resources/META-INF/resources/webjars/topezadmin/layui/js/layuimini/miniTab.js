    ...
    var miniTab = {
        ...
        create: function (options) {
            ...
            ele.tabAdd('layuiminiTab', {
                title: '<span class="layuimini-tab-active layui-icon-refresh layui-icon"></span><span>' + options.title + '</span><i class="layui-icon layui-unselect layui-tab-close">ဆ</i>' //用于演示
                ,
