...
public final class StringHelper {
	 ...
	 * @param qualifierBase
	 *            The qualifier base.
	 * @return The name itself, or the partially unqualified form if it begins with
	 *         the qualifier base.
	 */
	...
	/**
	 * Cross between {@link #collapse} and {@link #partiallyUnqualify}. Functions
	 * much like {@link #collapse} except that only the qualifierBase is collapsed.
	 * For example, with a base of 'org.hibernate' the name
	 ...
	 * @param qualifierBase
	 *            The qualifier base.
	 * @return The name itself if it does not begin with the qualifierBase, or the
	 *         properly collapsed form otherwise.
	 */
